 ...
 * @author PC
 */
public class FindProInInventoryServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Inventory> list = iD.getInventoryByProductName(name.trim());
        session.setAttribute("inven", list);
        request.getRequestDispatcher("list-inventory.jsp").forward(request, response);
    } 
