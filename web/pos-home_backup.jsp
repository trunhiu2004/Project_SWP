        ...
        <div class="wrapper fix">
                            ...
                            <div class="order_holder1">
                                ...
                                <c:forEach items="${cart}" var="item">
                                    <div class="order_item_row">
                                        <div class="item_name">${item.storeStock.inventory.product.name}</div>
                                        <div class="item_price">${item.price}</div>
                                        <div class="item_qty">${item.quantity}</div>
                                        <div class="item_total">${item.subtotal}</div>
                                    </div>
                                </c:forEach>
                            </div>
                    ...
                    <div id="bottom_absolute">
                        <div class="bottom__info">
                            ...
                            <div class="total_section">
                                ...
                                <div class="total_amount">${requestScope.cartTotal}</div>
                            </div>
                                    ...
                                    <div id="searched_item_found1" class="specific_category_items_holder1">
                                        <div class="single-inner-div grocery_single_off">
                                            <c:forEach items="${store}" var="s">
                                                <a href="#" item-type="General_Product" plain-id="${s.storeStockId}" data-last_purchase_price="310" is_promo="No"
                                                   data-whole_sale_price="340" data-sale_price="350" class="single_item  all_brand brand_0 "
                                                   id="item_${s.storeStockId}" style="text-decoration: none; display: inline-block;">
            ...
            <html lang="en">
                ...
                <body>
                    ...
                    <!-- Plugin Js End -->
                    <!-- Custom JS Start -->
                    <script src="assets/js/POS/stripe.js"></script>
