...
<!-- Mirrored from templates.iqonic.design/posdash/jsp/backend/home_1.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Sep 2024 10:42:55 GMT -->
<head>
    <meta charset="utf-8">
      ...
      <!-- Favicon -->
      <link rel="shortcut icon" href="https://templates.iqonic.design/posdash/jsp/assets/images/favicon.ico" />
  ...
  <body class="  ">
    ...
    <div class="wrapper">
                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                      ...
                      <li class=" ">
                        ...
                        <ul id="inventory" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            ...
                            <li class="">
                                <a href="listLogInventory">
                                    <i class="las la-minus"></i><span>List Log Inventory</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                          ...
                          <ul id="otherpage" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  <li class=" ">
                                      ...
                                      <ul id="user" class="iq-submenu collapse" data-parent="#otherpage">
                                              <li class="">
                                                  <a href="https://templates.iqonic.designdash/jsp/app/user-profile.jsp">
                                                      <i class="las la-minus"></i><span>User Profile</span>
                                                  </a>
                                              </li>
                                              <li class="">
                                                  <a href="https://templates.iqonic.design/posdash/jsp/app/user-add.jsp">
                                                      <i class="las la-minus"></i><span>User Add</span>
                                                  </a>
                                              </li>
                                              <li class="">
                                                  <a href="https://templates.iqonic.design/posdash/jsp/app/user-list.jsp">
                                          ...
                                          <div class="card-body p-0 text-center">
                                              ...
                                              <div class="p-3">
                                                  ...
                                                  <div class="d-flex align-items-center justify-content-center mt-3">
                                                      <a href="https://templates.iqonic.design/posdash/jsp/app/user-profile.jsp" class="btn border mr-2">Profile</a>
                                                      <a href="auth-sign-in.jsp" class="btn border">Sign Out</a>
                                                  </div>
                                              </div>
                                          </div>
                                      </div>
      ...
      <div class="modal fade" id="POS" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                  <div class="modal-body">
                      
                          <h4 class="mb-3">POS</h4>
...
<!-- Mirrored from templates.iqonic.design/posdash/jsp/backend/home_1.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Sep 2024 10:43:21 GMT -->
