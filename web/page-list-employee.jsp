                                    ...
                                    <tbody>
                                        <c:forEach var="employee" items="${requestScope.employee}">
                                            <tr>
                                                <td>
                                                    <div class="checkbox d-inline-block">
                                                        <input type="checkbox" class="checkbox-input" id="checkbox-${employee.employee_id}">
                                                        <label for="checkbox-${employee.employee_id}" class="mb-0"></label>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="EditEmployee?id=${employee.employee_id}" class="btn btn-warning">Edit</a>
                                                    <a href="DeleteEmployee?id=${employee.employee_id}" onclick="return confirm('Are you sure you want to delete this employee?');" class="btn btn-sm btn-danger">Delete</a>
